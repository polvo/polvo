...
(function() {
  ...
  module.exports = Optimizer = (function() {
    ...
    Optimizer.prototype.copy_vendors_to_release = function(all, specific, log_time) {
      return this.vendors_paths = this.vendors_js.copy_to_release(all, specific, log_time);
    };

    Optimizer.prototype.write_amd_loader = function() {
      return this.loader.write_amd_loader(this.vendors_paths);
    };
    ...
    Optimizer.prototype.merge_everything = function() {
      ...
      buffer = "//---------------------------------------- amd loader\n\n\n";
      buffer += this.loader.get_amd_loader();
      buffer += "//---------------------------------------- vendors\n\n\n";
    ...
    Optimizer.prototype.reorder = function(files, cycling) {
      var bc, dep, dependency, dependency_index, file, file_index, found, i, id, index, not_found, _i, _j, _k, _len, _len1, _len2, _ref1, _ref2;
