...
(function() {
  var Coffeescript, File, Html, Jade, Javascript, Stylus, debug, error, fs, fsu, log, path, warn, _ref,
  ...
  module.exports = File = (function() {
    File.EXTENSIONS = [Coffeescript.EXT, Javascript.EXT, Jade.EXT, Html.EXT, Stylus.EXT];

    File.COMPILERS = [Coffeescript, Javascript, Jade, Html, Stylus];
