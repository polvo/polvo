...
(function() {
  var Coffeescript, File, Jade, Javascript, Stylus, debug, error, fs, fsu, log, path, warn, _ref,
  ...
  module.exports = File = (function() {
    File.EXTENSIONS = [Coffeescript.EXT, Javascript.EXT, Jade.EXT, Stylus.EXT];

    File.COMPILERS = [Coffeescript, Javascript, Jade, Stylus];
    ...
    function File(polvo, cli, config, tentacle, tree, src_dir, absolute_path) {
      ...
      Coffeescript.POLVO = Javascript.POLVO = Jade.POLVO = Stylus.POLVO = this.polvo;
