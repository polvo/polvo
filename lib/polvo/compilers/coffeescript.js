...
(function() {
  ...
  module.exports = Coffeescript = (function() {
    ...
    Coffeescript.compile = function(file, after_compile) {
      var bare, clean, compiled, contents, err, global_code, global_reg, global_res, indented, literate, map, raw, sourceMap, temp;
    ...
    Coffeescript.reindent = function(code) {
      var identation, indented, match_identation;
      ...
      return indented = code.replace(/^/mg, "" + identation);
    };
