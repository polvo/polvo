...
(function() {
  ...
  module.exports = Html = (function() {
    ...
    Html.compile = function(file, after_compile, compile_dependents) {
      ...
      contents = this.render_partials(file);
    ...
    Html.render_partials = function(file) {
      var contents, include, include_contents, include_path, match;
    ...
    Html.compile_dependents = function(file) {
      ...
      for (_k = 0, _len2 = files.length; _k < _len2; _k++) {
        ...
        _results.push((function() {
          var _results1;
          _results1 = [];
          while ((match = inc_all_reg.exec(f.raw)) != null) {
            import_path = match[1];
