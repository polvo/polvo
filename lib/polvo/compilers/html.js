...
(function() {
  ...
  module.exports = Html = (function() {
    ...
    Html.compile_dependents = function(file) {
      var abs_path, compile_dependents, f, files, has_inc_reg, import_dir, import_dir_parts, import_file, import_path, inc_all_reg, match, parent_dir_parts, part, tentacle, tree, _i, _j, _k, _len, _len1, _len2, _ref1, _ref2, _results;
