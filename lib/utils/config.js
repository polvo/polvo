...
(function() {
  ...
  parse_config = function(config_file) {
    var config, dirpath, index, _i, _len, _ref1, _ref2, _ref3;
    ...
    if (config.minify != null) {
      config.minify.js = (_ref2 = config.minify.js) != null ? _ref2 : true;
      config.minify.css = (_ref3 = config.minify.css) != null ? _ref3 : true;
    } else {
      config.minify = {
        js: true,
        css: true
