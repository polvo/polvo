...
(function() {
  var Cli, alias, argv, cli, colors, dirs, log_to_stderr, log_to_stdout, util,
    __slice = [].slice;
  ...
  module.exports.error = function() {
    ...
    return log_to_stderr(['error'.red, msg.grey].concat(args));
  };

  module.exports.warn = function() {
    var args, msg;
    msg = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    return log_to_stderr([' warn'.yellow, msg.grey].concat(args));
  };

  module.exports.info = function() {
    var args, msg;
    msg = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    return log_to_stdout = [' info'.cyan, msg.grey].concat(args);
  };
