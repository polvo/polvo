...
exports.build_js = function(notify) {
  var all, base64_maps, boot, buffer, comp, comp_name, each, helper, helpers, js, k, linesnum, merged, offset, split_paths, src_maps, start, tmp, v, _i, _j, _len, _len1;
...
build_js_split = function(files, notify) {
  var base, buffer, file, filefolder, filename, folder, httpath, js_folder, map, map64, output, paths, _i, _len;
