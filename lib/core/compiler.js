...
var argv, auto_reload, build_js_split, cli, compilers, config, debug, dirs, error, files, fs, fsu, get_split_base_dir, helpers_path, humanize, info, io_path, loader, loader_path, log_compiled, logger, minify, path, prefix, reloader_path, server, source_maps_header, sourcemaps, split_loader, split_loader_path, sufix, warn, zlib, _;
...
exports.release = function() {
  var js, jss, uncompressed, _i, _len;
...
exports.notify = function(filepath) {
  var fsize;
  ...
  return zlib.gzip(fs.readFileSync(filepath, 'utf-8'), function(err, gzip) {
    ...
    return fs.unlinkSync(filepath + '.tmp.gzip');
  });
};
