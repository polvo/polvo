...
var File, Files, cli, compiler, config, debug, dirs, error, fs, fsu, info, log_changed, log_created, log_deleted, logger, path, plugins, warn, _,
...
module.exports = new (Files = (function() {
  ...
  Files.prototype.create_file = function(filepath) {
    var file;
    if ((filepath === path.resolve(filepath)) && !fs.existsSync(filepath)) {
      return;
    }
