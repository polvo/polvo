...
(function() {
  ...
  module.exports = new (Files = (function() {
    ...
    function Files() {
      ...
      this.on_new_dependencies = __bind(this.on_new_dependencies, this);
      this.collect();
    }
    ...
    Files.prototype.create_file = function(filepath) {
      ...
      file.on('new:dependencies', this.on_new_dependencies);
      file.init();
    ...
    Files.prototype.on_new_dependencies = function(deps) {
