...
(function() {
  var Cli, File, MicroEvent, dirs, fs, path, plugins, prefix, scan, sufix,
  ...
  module.exports = File = (function(_super) {
    ...
    function File(filepath) {
      ...
      _ref = this.compiler, this.type = _ref.type, this.output = _ref.output;
    ...
    File.prototype.compile = function(done) {
      var _this = this;
      return this.compiler.compile(this.filepath, this.raw, argv.release, function(compiled, map) {
    ...
    File.prototype.scan_deps = function() {
      ...
      if (this.type === 'script') {
        ...
        if (this.is_partial) {
          return this.depts = scan.dependents(this, this.filepath, this.compiled);
        } else {
          return this.depts = [];
        }
      }
