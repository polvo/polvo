...
var Cli, File, MicroEvent, debug, dirs, error, fs, info, path, plugins, prefix, scan, sufix, warn, _, _ref,
...
_ref = require('../utils/log')('core/file'), error = _ref.error, warn = _ref.warn, info = _ref.info, debug = _ref.debug;
