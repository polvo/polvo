...
(function() {
  ...
  module.exports = Polvo = (function() {
    ...
    Polvo.prototype.init = function(compile_at_startup) {
      var conf, _i, _len, _ref1, _results;

      this.tentacless = [];
      this.tentacles = new Config(this);
      _ref1 = this.tentacles.confs;
      _results = [];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        conf = _ref1[_i];
        _results.push(this.tentacless.push(new Tentacle(this, this.cli, conf)));
      }
      return _results;
    };

    Polvo.prototype.compile = function(header_code, footer_code) {
      var tentacle, _i, _len, _ref1, _results;
      ...
      _ref1 = this.tentacless;
      _results = [];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        tentacle = _ref1[_i];
        if ((this.cli.argv.c != null) || (this.cli.argv.w != null)) {
          _results.push(tentacle.compile(header_code, footer_code));
        } else if (this.cli.argv.r) {
          _results.push(tentacle.optimize(header_code, footer_code));
        } else {
