...
(function() {
  var esprima, filter_deps, fs, fsu, path, resolve, _;
  ...
  exports.js = function(filepath, raw) {
    var aliased, dep, _i, _len, _ref;
    aliased = {};
    _ref = filter_deps(esprima.parse(raw));
  ...
  exports.css = function(file, filepath, raw) {
    return {};
  };

  filter_deps = function(node, found) {
