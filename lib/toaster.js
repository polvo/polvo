...
(function() {
  var ArrayUtil, Cli, Config, FnUtil, ObjectUtil, Project, Question, Script, StringUtil, Toast, Toaster, debug, error, exec, fs, growl, icon_error, icon_warn, interval, log, msgs, os, path, process_msgs, queue_msg, start_worker, stop_worker, warn,
  ...
  __t('toaster.core').Script = (function() {
    var cs, fs, path, uglify, uglify_parser;
  ...
  FnUtil = require('../utils/fs_util');

  ArrayUtil = require('../utils/array_util');
  ...
  __t('toaster.core').Builder = (function() {
    ...
    Builder.prototype.init = function() {
      var falias, file, folder, fpath, include, item, result, _i, _len, _ref, _results;
      this.files = [];
    ...
    Builder.prototype.build = function() {
      ...
      if (this.cli.argv.a) {
        ...
        if (process.argv.length > 3) {
          for (i = _i = 3, _ref = process.argv.length; _i < _ref; i = _i += 1) {
    ...
    Builder.prototype.watch = function() {
      var src, watcher, _i, _len, _ref, _results;
      this.watchers = [];
      _ref = this.config.src_folders;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    Builder.prototype.on_fs_change = function(src, ev, f) {
      var falias, file, fpath, include, item, msg, now, relative_path, script, spath, type, _i, _len, _ref;
    ...
    Builder.prototype.compile = function() {
      var file, index, _i, _len, _ref, _results;
      _ref = this.files;
      _results = [];
    ...
    Builder.prototype.reorder = function(cycling) {
      var bc, dep, dependency, dependency_index, file, file_index, filepath, found, i, index, not_found, _i, _j, _len, _len1, _ref, _ref1, _results;
      if (cycling == null) {
        cycling = false;
      }
      if (cycling === false) {
  ...
  exports.module = Toaster = (function() {
    var colors, fsu;
