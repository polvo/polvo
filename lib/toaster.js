...
(function() {
  ...
  __t('toaster.core').Script = (function() {
    ...
    Script.prototype.getinfo = function(declare_ns) {
      var baseclass, decl, item, klass, name, repl, requirements, rgx, rgx_ext, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3;
      if (declare_ns == null) {
        declare_ns = true;
      }
      ...
      if (this.raw.match(rgx) != null) {
        if (this.namespace !== "" && this.builder.packaging) {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            repl = "class " + this.namespace + "." + name + this.extending;
            if (decl !== repl) {
      ...
      if (/(#<<\s)(.*)/g.test(this.raw)) {
        ...
        for (_k = 0, _len2 = requirements.length; _k < _len2; _k++) {
          ...
          this.dependencies_collapsed = this.dependencies_collapsed.concat(item);
        }
      }
      return this.backup = this.raw;
    };
    ...
    Script.prototype.expand_dependencies = function() {
      ...
      this.inject_definitions();
      return this.dependencies;
    };

    Script.prototype.inject_definitions = function() {
      var dep, deps, exp, identation, idented, match_identation, ns_rest, ns_root, root, _i, _len, _ref;
      deps = "";
      ...
      if (this.builder.nature === 'browser') {
        ...
        this.raw = "__toast " + ns_root + ", '" + ns_rest + "'\n";
        return this.raw += "define '" + this.classpath + "', [" + deps + "], -> \n" + idented;
